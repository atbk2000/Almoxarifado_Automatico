...
<a href="../assets/img/placas.jpg"><img class="mx-auto d-block" src="../assets/img/controlador-cad-base.png" style="width:65%;height:65%;"></a>
 <figcaption class="figure-caption text-center">Modelo CAD da base do controlador</figcaption>
  </p>
  
  
  <p style="margin-bottom: 0px;">
<a href="../assets/img/placas.jpg"><img class="mx-auto d-block" src="../assets/img/controlador-cad-tampa.png" style="width:65%;height:65%;"></a>
 <figcaption class="figure-caption text-center">Modelo CAD da parte superior do controlador</figcaption>
  </p>
  
  
    <p style="margin-bottom: 0px;">
<a href="../assets/img/placas.jpg"><img class="mx-auto d-block" src="../assets/img/controlador2.jpg" style="width:65%;height:65%;"></a>
 <figcaption class="figure-caption text-center">Modelo CAD da parte superior do controlador</figcaption>
  </p>
